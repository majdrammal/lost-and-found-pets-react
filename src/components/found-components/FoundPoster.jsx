...
const FoundPoster = ({ index, type, image, breed, gender, ageRange, date, location, number, description}) => {
    ...
    return (
        <div className="found__poster" key={index}>
            ...
            <h2 className="poster__title">Found {type}!</h2>
            <div className="poster__body">
                <img className='poster__img' src={image} alt="" />
                    <ul className="poster__descriptions">
                        ...
                        <li className="poster__description"><b>Age Range: </b>{ageRange}</li>
                        <br/>
